...
<body id="app" >
    <div class="wrapper">
    	<div class="pos-container p-3 pt-0">
	    	...
	    	<div class="row">
	    		<div class="col-sm-6">
	    			<div class="d-flex justify-content-between pos-header mb-3 p-2">
		    			<div class="logo-img">
		    				<a href="{{route('dashboard')}}">
				               <img height="30" src="{{ asset('img/logo.png')}}" class="header-brand-img" title="Ergnation">
				           </a>
			            </div>
		    			<div class="top-menu d-flex justify-content-right">
		    				<a href="{{url('dashboard')}}" class="nav-link ml-10" ><i class="ik ik-globe"></i></a>
					        	...
					        	<div class="form-group">
			                        <div class="row">
			                            ...
			                            <div class="col-sm-2 pl-1 pt-1">
			                                <button type="button" class=" btn btn-sm btn-primary" data-toggle="modal" data-target="#CustomerAdd">+</button>
			                            </div>
			        		...
			        		<div class="col-xl-3 col-lg-4 col-12 col-sm-6 mb-2 list-item list-item-grid">
			        			<div class="card mb-1">
			        				<div class="d-flex card-img">
			        					...
			        					<span class="badge badge-pill badge-success position-absolute badge-top-left"><sup>$</sup> 100</span>

			        				</div>
			        				<p class="p-2">

			        					<b>HeadPhone </b><br>
			        					<span class="text-small text-muted">EH1234</span><br>
			        				</p>
			        		...
			        		<div class="col-xl-3 col-lg-4 col-12 col-sm-6 mb-2 list-item list-item-grid">
			        			<div class="card mb-1">
			        				<div class="d-flex card-img">
			        					...
			        					<span class="badge badge-pill badge-success position-absolute badge-top-left"><sup>$</sup> 5000</span>
			        		...
			        		<div class="col-xl-3 col-lg-4 col-12 col-sm-6 mb-2 list-item list-item-grid">
			        			<div class="card mb-1">
			        				<div class="d-flex card-img">
			        					...
			        					<span class="badge badge-pill badge-success position-absolute badge-top-left"><sup>$</sup> 500</span>
			        		...
			        		<div class="col-xl-3 col-lg-4 col-12 col-sm-6 mb-2 list-item list-item-grid">
			        			<div class="card mb-1">
			        				<div class="d-flex card-img">
			        					...
			        					<span class="badge badge-pill badge-success position-absolute badge-top-left"><sup>$</sup> 5500</span>
	    		...
	    		<div class="col-sm-6 bg-white h-100vh">
	    			<div class="salestable p-3">
                    ...
                    <div class="payment-area p-3">

                        <div class="row mr-2">
                        	<div class="col-sm-5">
                        		<div class="form-group pos-form-group">
                        			<label>TAX (%)</label>
                        			<input type="text" name="shiping" class="form-control" value="" placeholder="Enter tax %">
                        		</div>


                        		<div class="form-group pos-form-group">
                        			<label>Shiping</label>
                        			<input type="text" name="shiping" class="form-control" value="" placeholder="Enter shipping charge">
                        		</div>


                        		<div class="form-group pos-form-group">
                        			<label>Discount (%)</label>
                        			<input type="text" name="shiping" class="form-control" value="" placeholder="Enter discount amount">
                        		</div>
                        	</div>

                        	<div class="col-sm-7 text-right pl-4 pt-2">
                        		<div class="d-flex justify-content-between w-300 " >
                        			<strong>Total Products:</strong>  <span class="total">2</span>
                        		</div>
                        		<div class="d-flex justify-content-between w-300 ">
                        			<strong>Total Amount:</strong>  <span class="total"> <span class="text-small">$ </span> 720</span>
                        		</div>
                        		<div class="w-300 mt-3">
	                        		<button class="btn btn-danger btn-checkout w-200" data-toggle="modal" data-target="#InvoiceModal"><i class="ik ik-shopping-cart"></i>  PAY NOW</button>
                        		</div>
	                ...
	                <div class="card-body">
	                    <div class="row invoice-info">
	                        <div class="col-sm-4 invoice-col">
	                            From
	                            <address>
	                                <strong>Radmin,</strong><br>795 Folsom Ave, Suite 546 <br>San Francisco, CA 54656 <br>Phone: (123) 123-4567<br>Email: info@Ergnation.com
	                            </address>
	                        </div>
	                        <div class="col-sm-4 invoice-col">
	                            To
