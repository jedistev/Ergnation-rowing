...
<html class="no-js" lang="en">
    <head>
        ...
        <title>{{ __('Sign Up | Ergnation')}}</title>
                        ...
                        <div class="authentication-form mx-auto">
                            ...
                            <form action="{{url('register')}}" method="post">
                                ...
                                <div class="form-group">
                                    <input type="name" class="form-control" placeholder="User Name" name="name" value="{{ old('name') }}" required>
                                    <i class="ik ik-user"></i>
                                </div>
                                <div class="form-group">
                                    <input type="firstname" class="form-control" placeholder="first Name" name="firstname" value="{{ old('firstname') }}" required>
                                    <i class="ik ik-user"></i>
                                </div>
                                <div class="form-group">
                                    <input type="surname" class="form-control" placeholder="surname" name="surname" value="{{ old('surname') }}" required>
                                    <i class="ik ik-user"></i>
                                </div>
                                <div class="form-group">
