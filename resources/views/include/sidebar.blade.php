    ...
    <div class="sidebar-content">
        <div class="nav-container">
            <nav id="main-menu-navigation" class="navigation-main">
                ...
                <div class="nav-item {{ ($segment1 == 'users' || $segment1 == 'roles'|| $segment1 == 'teams'|| $segment1 == 'newteam'||  $segment1 == 'profile'||$segment1 == 'permission' ||$segment1 == 'user') ? 'active open' : '' }} has-sub">
