                        ...
                        @csrf
                            ...
                            <div class="row">
                                <div class="col-sm-6">
                                    ...
                                    <div class="form-group">
                                        <label for="surname">{{ __('Surname')}}<span class="text-red">*</span></label>
                                        <input id="surname" type="text" class="form-control @error('surname') is-invalid @enderror" name="surname" value="{{ clean($user->surname, 'titles')}}" placeholder="Enter user surname" required>
                                        <div class="help-block with-errors"></div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input id="firstname" type="text" class="form-control @error('firstname') is-invalid @enderror" name="firstname" value="{{ clean($user->firstname, 'titles')}}" placeholder="Enter user firstname" required>
                                        <div class="help-block with-errors"></div>
